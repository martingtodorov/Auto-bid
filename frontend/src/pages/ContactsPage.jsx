      ...
      <InfoSection title="Специализирани запитвания">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          <div className="rounded-card border border-[hsl(var(--line))] bg-white p-5">
            ...
            <a href="mailto:dealers@autobid.bg" className="mt-3 inline-block text-sm font-semibold text-[hsl(var(--accent))] hover:underline">dealers@autobid.bg →</a>
          </div>
          <div className="rounded-card border border-[hsl(var(--line))] bg-white p-5">
            <div className="overline text-[hsl(var(--accent))]">Преса и медии</div>
            <p className="mt-2 text-sm">За интервюта, доклади и статистики.</p>
            <a href="mailto:press@autobid.bg" className="mt-3 inline-block text-sm font-semibold text-[hsl(var(--accent))] hover:underline">press@autobid.bg →</a>
          </div>
        </div>
      </InfoSection>
    </>
